...
composite_impact2_2 <- FDS_CMR_2024_main %>%
...
composite_impact2_2 <- composite_impact2_2 %>%
  mutate(
    facility_label = dplyr::recode(
      ...
      "Improved_dw_access" = "Improved Drinking Water",
...
HHroster <- HHroster %>%
  mutate(
    age_primary = case_when(
      ...
      agetouse >= 6 & agetouse <= 14 ~ 1,  #Remember to adjust age levels based on the primary education age per country
